package com.recon.ingestion.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, FileArrivedEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.recon.*");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, FileArrivedEvent.class.getName());
